...
import cartoonProfile from '../assets/images/ChatGPT-miriam-profile.png'
import realProfile from '../assets/images/miriam-profile-v1.jpg'
			...
			<main style={{padding: '2rem'}}>
				...
				<div className={styles.heroSection}>
					<div className={styles.imageContainer}>
						<img src={cartoonProfile} alt="Cartoon profile picture of Miriam" className={styles.profileImage} />
						<img src={realProfile} alt="Real profile picture of Miriam" className={styles.profileImageHover} />
					</div>
